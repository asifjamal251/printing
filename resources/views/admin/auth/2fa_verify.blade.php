                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    {!! Form::open(['method' => 'POST', 'route' => 'admin.2fa.verify.post', 'class' => 'form-horizontal']) !!}
                                
                                    <div class="form-group{{ $errors->has('one_time_password') ? ' has-error' : '' }}">
                                        {!! Form::label('one_time_password', 'OTP') !!}
                                        {!! Form::text('one_time_password', null, ['class' => 'form-control', 'Placeholder' => 'Enter OTP']) !!}
                                        <small class="text-danger">{{ $errors->first('one_time_password') }}</small>
                                    </div>
                                
                                    <div class="mt-4">
                                        {!! Form::submit("Verify OTP", ['class' => 'btn btn-success w-100']) !!}
                                    </div>
