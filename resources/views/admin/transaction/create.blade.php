                    ...
                    <div class="form-group col-md-3 col-sm-12">
                     ...
                     <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('dye_lock') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('dye_lock', ['catch cover'=>'catch cover', 'interlock'=>'interlock', 'lockbottom'=>'lockbottom', 'BSO'=>'BSO', 'tube'=>'tube'], null, ['id' => 'dye_lock', 'class' => 'form-control', 'placeholder' => 'Dye Lock']) !!}
