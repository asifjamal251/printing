...
<<<<<<< HEAD
                    <tr style="vertical-align:top;">
                        <td colspan="4">
                            ...
                            <p style="margin-bottom: 0;"><b>Email: </b>{{$material->billto->email}}</p>
                            <p style="margin-bottom: 0;"><b>Mobile No.: </b> {{$material->billto->mobile_number}}</p>
                            <p style="margin-bottom: 0;"><b>GST: </b> {{$material->billto->gst}}</p>
                            <p style="margin-bottom:0"><b>Address: </b>{{$material->billto->address}}, <br>{{$material->billto->locality}} {{$material->billto->city->name}}, <br>{{$material->billto->state->name}} - {{$material->billto->pincode}}</p>
                        </td>

                        <td colspan="4">
                            <p><b>{{$material->shipTo->name}}</b></p>
                            <p style="margin-bottom: 0;"><b>Email: </b>{{$material->shipTo->email}}</p>
