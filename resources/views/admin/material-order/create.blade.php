...
>>>>>>> 2b33c6348bab638e807612609fb3df492f5146af
                        <div class="form-group{{ $errors->has('mo_date') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('mo_date', null, ['class' => 'form-control form-control-sm dateSelector', 'placeholder' => 'Enter MO Date']) !!}
...
<<<<<<< HEAD
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('bill_to') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('bill_to', App\Models\Vendor::pluck('name', 'id'), null, ['id' => 'bill_to', 'class' => 'form-control form-control-sm select2', 'placeholder' => 'Bill To']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('ship_to') ? ' has-error' : '' }}">
                            {!! Form::label('ship_to', 'Ship To') !!}
                            {!! Form::select('ship_to', App\Models\Vendor::pluck('name', 'id'), null, ['id' => 'ship_to', 'class' => 'form-control form-control-sm select2', 'placeholder' => 'Ship To']) !!}
                                ...
                                <div class="custom-row stock-error">
                                    ...
                                    <div class="form-group col-wt-pc">
                                        <div class="form-group{{$errors->has('kt_docs_repeater_advanced.'.$loop->index.'.weight_per_piece') ? ' has-error' : '' }}">
                                            ...
                                            {!! Form::text('weight_per_piece', old('kt_docs_repeater_advanced.'.$loop->index.'.weight_per_piece', $item['weight_per_piece'] ?? ''), ['class' => 'form-control form-control-sm', 'placeholder' => 'WT/PC', 'readonly']) !!}
                                    ...
                                    <div class="form-group col-wt">
                                        <div class="form-group{{$errors->has('kt_docs_repeater_advanced.'.$loop->index.'.total_weight') ? ' has-error' : '' }}">
                                            ...
                                            {!! Form::text('total_weight', old('kt_docs_repeater_advanced.'.$loop->index.'.total_weight', $item['total_weight'] ?? ''), ['class' => 'form-control form-control-sm', 'placeholder' => 'Total Weight', 'readonly']) !!}
                                    ...
                                    <div class="form-group col-rate-on rate-amount">
                                        <div class="form-group{{$errors->has('kt_docs_repeater_advanced.'.$loop->index.'.rate_on') ? ' has-error' : '' }}">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                {!! Form::text('rate_on', old('kt_docs_repeater_advanced.'.$loop->index.'.rate_on', $item['rate_on'] ?? ''), ['class' => 'form-control form-control-sm rate_on', 'placeholder' => 'Rate On', 'readonly']) !!}
                                            </div>
                                    ...
                                    <div class="form-group col-gst">
                                        ...
                                        <div class="form-group{{$errors->has('kt_docs_repeater_advanced.'.$loop->index.'.gst') ? ' has-error' : '' }}">
                                            {!! Form::label('gst', 'GST') !!}
                                            <div class="input-group input-group-sm">
                                                {!! Form::text('gst', old('kt_docs_repeater_advanced.'.$loop->index.'.gst', $item['gst'] ?? ''), ['class' => 'form-control form-control-sm gst', 'placeholder' => 'GST %', 'readonly' ]) !!}
                                                <span class="input-group-text">%</span>
                                            </div>
                                    ...
                                    <div class="form-group col-gst_amount" style="display:none;">
                                        ...
                                        <div class="form-group{{$errors->has('kt_docs_repeater_advanced.'.$loop->index.'.gst_amount') ? ' has-error' : '' }}">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">₹</span>
                                                {!! Form::text('gst_amount', old('kt_docs_repeater_advanced.'.$loop->index.'.gst_amount', $item['gst_amount'] ?? 18), ['class' => 'form-control form-control-sm gst_amount', 'placeholder' => '₹ GST', 'readonly' ]) !!}  
                                            </div>
                        ...
                        <div class="card-body text-start">
                            <div class="mb-3 form-group{{ $errors->has('subtotal') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">₹</span>
                                    {!! Form::text('subtotal', null, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Subtotal', 'readonly']) !!}
                                </div>
                            ...
                            <div class="mb-3 form-group{{ $errors->has('total_gst') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">₹</span>
                                    {!! Form::text('total_gst', null, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Total GST Amount', 'readonly']) !!}
                                </div>
                            ...
                            <div class="form-group{{ $errors->has('total') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">₹</span>
                                    {!! Form::text('total', null, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Total Amount', 'readonly']) !!}
                                </div>
