                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('bill_to') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('bill_to', App\Models\Vendor::pluck('name', 'id'), $material->bill_to, ['id' => 'bill_to', 'class' => 'form-control form-control-sm select2', 'placeholder' => 'Bill To']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('ship_to') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('ship_to', App\Models\Vendor::pluck('name', 'id'), $material->ship_to, ['id' => 'ship_to', 'class' => 'form-control form-control-sm select2', 'placeholder' => 'Ship To']) !!}
                                ...
                                <div class="custom-row stock-error">
                                    ...
                                    <div class="form-group col-unit">
                                        <div class="form-group{{$errors->has('kt_docs_repeater_advanced.'.$loop->index.'.unit') ? ' has-error' : '' }}">
                                            ...
                                            {!! Form::select('unit', App\Models\Unit::pluck('name', 'id'), $item->unit_id, ['id' => 'unit', 'class' => 'form-control form-control-sm', 'placeholder' => 'Unit']) !!}
