            ...
            <div class="modal-content">
                ...
                <div class="modal-footer bg-light py-2 justify-content-center">
                    <div class="hstack gap-2 justify-content-center">
                        ...
                        <button class="btn btn-sm btn-warning pauseTimer"><i class="ri-links-line align-bottom"></i> Pause</button>
                        <button class="btn btn-sm btn-danger stopTimer"><i class="ri-links-line align-bottom"></i> Stop</button>
                    </div>
                </div>
            </div>
        </form>
...
$(document).ready(function(){
    ...
    "columns": [
        ...
        { "data": "timer",
            render: function(data, type, row) {
                return '<button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#timerModel">Timer</button>';
            }
        },
        {
            "data": "action",
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    @can(['edit_cutting','delete_cutting','read_cutting'])
                        ...
                        btn+='<li><a class="dropdown-item edit-item-btn" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#timerModel"><i class="ri-check-double-line align-bottom me-2 text-muted"></i> Timer</a></li>';
...
$('body').on('click', '.filters', function(){
    ...
    $('body').on('change', '.cutting-sheet-input', function(){
        ...
        //if(cutting_sheets == total_sheets){
            $.ajax({
                type: "POST",
        ...
        //     $(this).val('');
        //     Toastify({
        //         text: 'Printed Sheets always equal to Total Sheets.',
        //         duration: 3000,
        //         close: true,
        //         gravity: "top", // `top` or `bottom`
        //         position: "right", // `left`, `center` or `right`
