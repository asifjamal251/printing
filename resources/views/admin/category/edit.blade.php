                ...
                <div class="card-body" id="form">
                    ...
                    {!! Form::open(['method' => 'POST', 'route' => 'admin.'.request()->segment(2).'.store', 'class' => 'form-horizontal','id'=>'MaterialForm']) !!}
                        ...
                        <div class="form-group{{ $errors->has('category_name') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('category_name', $category->name, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Enter Category Name']) !!}
                        ...
                        <div class="form-group{{ $errors->has('parent_category') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('parent_category', App\Models\Category::where('parent', null)->pluck('name','id'), $category->parent, ['id' => 'parent_category', 'class' => 'form-control', 'placeholder' => 'Select Parent Category']) !!}
                            <small class="text-danger">{{ $errors->first('parent_category') }}</small>
                        </div>
                    
                        <div class="btn-group">
                            {!! Form::submit("Update Category", ['class' => 'btn btn-success btn-border']) !!}
                        </div>
