                    ...
                    <div class="card-body">
                        <table id="datatable" class="datatable table table-bordered nowrap align-middle" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>Paper</th>
                                <th>Sheets</th>
                                @can(['edit_paper_warehouse','delete_paper_warehouse', 'read_paper_warehouse'])
                                  <th>Action</th>
                                @endcan
                            </tr>
                        </thead>
