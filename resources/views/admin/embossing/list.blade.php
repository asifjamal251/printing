...
$(document).ready(function(){
    ...
    "columns": [
        ...
        { "data": "embossing_counter",
            render: function(data, type, row) {
                if(row['status_id'] == 5){
                    return row['embossing_counter'];
                }else{
                    return '<input data-total="'+row['total_sheet']+'" data-id="'+row['id']+'" type="text" value="'+row['embossing_counter']+'" class="form-control form-control-sm embossing-input" name="embossing_counter[]" placeholder="Embossing Counter" style="max-width:100px;">';
                }
...
$('body').on('click', '.filters', function(){
    ...
    $('body').on('change', '.embossing-input', function(){
        ...
        if(printed_sheet < total_sheets){
            $.ajax({
                ...
                url: '{{ route('admin.embossing.update', '') }}/'+id,
