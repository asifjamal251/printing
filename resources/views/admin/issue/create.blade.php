                ...
                <div class="d-flex gap-3">
                    ...
                    <div class="custom-width w-100">
                        <div class="form-group{{ $errors->has('product') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('product', App\Models\Product::where('product_type_id', null)->pluck('name', 'id'), null, ['id' => 'product', 'class' => 'form-control getProduct', 'placeholder' => 'Choose Product']) !!}
                    ...
                    <div class="custom-width w-100">
                        <div class="form-group{{ $errors->has('quantity') ? ' has-error' : '' }}">
                            ...
                            {!! Form::number('quantity', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Quantity']) !!}
                    ...
                    <div class="custom-width w-100">
                        <div class="form-group{{ $errors->has('unit') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('unit', null, ['class' => 'form-control form-control-sm unit', 'placeholder' => 'Unit', 'readonly']) !!}
                    ...
                    <div class="custom-width w-100">
                        <div class="form-group{{ $errors->has('issue_for') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('issue_for', App\Models\Requisition::orderBy('name', 'asc')->pluck('name', 'id'), null, ['id' => 'issue_for', 'class' => 'form-control form-control-sm', 'placeholder' => 'Issue For']) !!}
                    ...
                    <div class="custom-width w-100">
                        <div class="form-group{{ $errors->has('oprator_name') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('oprator_name', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Oprator Name']) !!}
                  ...
                  <div class="custom-width" style="margin-top:28px;">
                      {!! Form::submit('Save Client Data', ['class' => 'btn btn-sm btn-info pull-right']) !!}
                  </div>
