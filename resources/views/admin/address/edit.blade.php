    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open(['route'=>['admin.'.request()->segment(2).'.update',$address->id],'method'=>'put', 'files'=>true]) !!}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('company_name') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('company_name', $address->company_name, ['class' => 'form-control', 'placeholder' => 'Company Name']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            {!! Form::email('email', $address->email, ['class' => 'form-control', 'placeholder' => 'eg: foo@bar.com']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('mobile_number') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('mobile_number', $address->mobile_number, ['id'=>'mobile_no', 'class' => 'form-control', 'placeholder' => 'Mobile Number']) !!}
                     ...
                     <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('gst') ? ' has-error' : '' }}">
                            {!! Form::label('gst', 'GST') !!}
                            {!! Form::text('gst', $address->gst, ['class' => 'form-control', 'placeholder' => 'GST']) !!}
                     ...
                     <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('state', $states, $address->state_id, ['id' => 'state', 'class' => 'form-control states', 'placeholder' => 'Choose State']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('city', App\Models\City::where('state_id', $address->state_id)->pluck('name', 'id'), $address->city_id, ['id' => 'city', 'class' => 'form-control getCity', 'placeholder' => 'Choose City']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('locality') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('locality', $address->locality, ['class' => 'form-control', 'placeholder' => 'Locality']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            {!! Form::textarea('address', $address->address, ['id'=>'address', 'class' => 'form-control', 'placeholder' => 'Address (Area and Street)', 'rows'=>1]) !!}
