    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="d-inline-block" style="max-width:20%;float:right;">
                ...
                @endif
                {{-- <div class="w-100">
                    @if($job_card->status_id == 1 || $job_card->status_id == 2)
                        {!! Form::button("Cancel ".Str::title(str_replace('-', ' ', request()->segment(2))), ['class' => 'btn btn-danger btn-border waves-effect waves-light', 'onclick'=>'cancelJobCard(this)']) !!}
                    @endif
                </div> --}}
            </div>
