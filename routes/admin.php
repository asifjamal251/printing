...
<<<<<<< HEAD
    ...
    Route::controller(AddressController::class)->group(function(){
        ...
        Route::get('address/create', 'create')->name('address.create')->middleware('can:add_address');
        Route::get('address/{address}', 'show')->name('address.show')->middleware('can:read_address');
        Route::get('address/{address}/edit', 'edit')->name('address.edit')->middleware('can:edit_address');
        Route::post('address', 'store')->name('address.store')->middleware('can:add_address');
        Route::put('address/{address}', 'update')->name('address.update')->middleware('can:edit_address');
        Route::delete('address/{address}/delete', 'destroy')->name('address.destroy')->middleware('can:delete_address');
    });
    ...
    Route::controller(DistrictController::class)->group(function(){
        ...
        Route::get('district/{district}', 'show')->name('district.show')->middleware('can:read_district');
        Route::get('district/{district}/edit', 'edit')->name('district.edit')->middleware('can:edit_district');
        Route::post('district', 'store')->name('district.store')->middleware('can:add_district');
        Route::put('district/{district}', 'update')->name('district.update')->middleware('can:edit_district');
        Route::delete('district/{district}/delete', 'destroy')->name('district.destroy')->middleware('can:delete_district');
    });
    ...
    Route::controller(CityController::class)->group(function(){
        ...
        Route::get('city/{city}', 'show')->name('city.show')->middleware('can:read_city');
        Route::get('city/{city}/edit', 'edit')->name('city.edit')->middleware('can:edit_city');
        Route::post('city', 'store')->name('city.store')->middleware('can:add_city');
        Route::put('city/{city}', 'update')->name('city.update')->middleware('can:edit_city');
        Route::delete('city/{city}/delete', 'destroy')->name('city.destroy')->middleware('can:delete_city');
    });
    ...
    Route::controller(StateController::class)->group(function(){
        ...
        Route::get('state/{state}', 'show')->name('state.show')->middleware('can:read_state');
        Route::get('state/{state}/edit', 'edit')->name('state.edit')->middleware('can:edit_state');
        Route::post('state', 'store')->name('state.store')->middleware('can:add_state');
        Route::put('state/{state}', 'update')->name('state.update')->middleware('can:edit_state');
