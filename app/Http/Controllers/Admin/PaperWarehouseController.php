...
use App\Http\Resources\Admin\PaperWarehouse\PaperWarehouseCollection;
...
class PaperWarehouseController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if ($request->ajax()) {
            $datas = PaperWarehouse::orderBy('created_at', 'desc');
            $totaldata = $datas->count();

            $search = $request->search['value'];

            if ($search) {
                $datas->where('paper_stock', 'like', '%'.$search.'%');
            }

            $request->merge(['recordsTotal' => $datas->count(), 'length' => $request->length]);
            $datas = $datas->limit($request->length)->offset($request->start)->get();

            return response()->json(new PaperWarehouseCollection($datas));
            
           
        }
        return view('admin.paper-warehouse.list');
    }

    public function create(){
        return view('admin.paper-warehouse.create');
    }
    ...
    public function store(Request $request) {
        ...
        if($client->save()){ 
            return redirect()->route('admin.paper-warehouse.index')->with(['class'=>'success','message'=>'Client Created successfully.']);
        }
    ...
    public function edit($id){
        ...
        return view('admin.paper-warehouse.edit', compact('client'));
    }
    ...
    public function show($id){
        ...
        return view('admin.paper-warehouse.view', compact('client'));
    }
